...
class RegisterController extends AbstractController
{
    ...
    public function index(Request $request, UserPasswordHasherInterface $userPasswordHasher, SendEmailService $emailService, JWTService $JWTService)
    {
        $user = new User();
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            try {
                ...
                $emailService->sendEmail(
                    ...
                    $user->getEmail(),
                    "Confirmation de la création de votre compte sur le site Snowtricks",
                    'register',
                    compact('user', 'token')
                );

                // Flash message and redirect after successful registration
