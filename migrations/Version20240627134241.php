 ...
 */
final class Version20240627134241 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD CONSTRAINT FK_8D93D6491677722F FOREIGN KEY (avatar) REFERENCES image (id)');
